...
public class Tuple8Assert<T1, T2, T3, T4, T5, T6, T7, T8>
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT1() first part} satisfies the given requirements.
	 *
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT2() second part} satisfies the given requirements.
	 *
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT3() third part} satisfies the given requirements.
	 *
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT4() fourth part} satisfies the given requirements.
	 *
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT5() fifth part} satisfies the given requirements.
	 *
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT6() sixth part} satisfies the given requirements.
	 *
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT7() seventh part} satisfies the given requirements.
	 *
	...
	/**
	 * Verifies that this tuple's {@link Tuple8#getT8() eighth part} satisfies the given requirements.
	 *
	 * @param t8Requirements the requirements for the eighth part, expressed in a {@link Consumer} in which further assertions can be applied
	 * @return {@code this} assertion object
	 */
