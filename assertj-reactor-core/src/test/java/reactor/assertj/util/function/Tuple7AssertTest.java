...
class Tuple7AssertTest {
	...
	void hasT1SatisfyingFails() {
		...
		).withMessage("Expected Tuple7 first part to satisfy requirements, but didn't.\nDetails: " +
				"\nExpecting:\n <\"example\">\nto start with:\n <\"foo\">\n");
	}
	...
	void hasT2SatisfyingFails() {
		...
		).withMessageStartingWith("Expected Tuple7 second part to satisfy requirements, but didn't.\nDetails: " +
				"\nExpecting:\n <123>\nto be greater than:\n <1000>");
	}
	...
	void hasT3SatisfyingFails() {
		...
		).withMessageStartingWith("Expected Tuple7 third part to satisfy requirements, but didn't.\nDetails: " +
				"\nExpecting:\n <45L>\nto be less than:\n <40L>");
	}
	...
	void hasT4SatisfyingFails() {
		...
		).withMessage("Expected Tuple7 fourth part to satisfy requirements, but didn't.\nDetails: " +
	...
	void hasT5SatisfyingFails() {
		...
		).withMessage("Expected Tuple7 fifth part to satisfy requirements, but didn't.\nDetails: " +
				"\nExpecting:\n <5>\nto be greater than:\n <100> ");
	}
	...
	void hasT6SatisfyingFails() {
		...
		).withMessage("Expected Tuple7 sixth part to satisfy requirements, but didn't.\nDetails: " +
				"\nExpecting:\n <6>\nto be greater than:\n <100> ");
	}
	...
	void hasT7SatisfyingFails() {
		...
		).withMessage("Expected Tuple7 seventh part to satisfy requirements, but didn't.\nDetails: " +
				"\nExpecting:\n <7>\nto be greater than:\n <100> ");
	}
}
